...
@router.get('/servers')
@require_permission(Services.infrastructure, Permissions.read)
...
@router.post('/deploy')
@require_permission(Services.infrastructure, Permissions.deploy)
...
@require_permission(Services.infrastructure, Permissions.manage)
